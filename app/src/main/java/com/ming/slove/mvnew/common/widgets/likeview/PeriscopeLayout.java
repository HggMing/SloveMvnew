...
package com.ming.slove.mvnew.common.widgets.likeview;
...
public class PeriscopeLayout extends RelativeLayout {
    ...
    private void init() {
        ...
        Drawable green = getResources().getDrawable(R.mipmap.pl_green);
        Drawable orange = getResources().getDrawable(R.mipmap.pl_orange);
        Drawable purple = getResources().getDrawable(R.mipmap.pl_purple);
    ...
    private PointF getPointF(int scale) {
        ...
        pointF.x = random.nextInt((mWidth - 10));//减去100 是为了控制 x轴活动范围,看效果 随意~~
        //再Y轴上 为了确保第二个点 在第一个点之上,我把Y分成了上下两半 这样动画效果好一些  也可以用其他方法
        pointF.y = random.nextInt((mHeight - 10)) / scale;
        return pointF;
    }
