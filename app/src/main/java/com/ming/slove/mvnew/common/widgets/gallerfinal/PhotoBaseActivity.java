...
import com.ming.slove.mvnew.common.widgets.gallerfinal.utils.MediaScanner;
...
public abstract class PhotoBaseActivity extends BaseActivity implements EasyPermissions.PermissionCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DisplayMetrics dm = ToolUtils.getScreenPix(this);
    ...
    protected void takePhotoAction() {
        ...
        if (ToolUtils.isEmpty(mPhotoTargetFolder)) {
            takePhotoFolder = GalleryFinal.getCoreConfig().getTakePhotoFolder();
        } else {
            takePhotoFolder = new File(mPhotoTargetFolder);
        }
        boolean suc = ToolUtils.mkdirs(takePhotoFolder);
        File toFile = new File(takePhotoFolder, "IMG" + ToolUtils.format(new Date(), "yyyyMMddHHmmss") + ".jpg");
