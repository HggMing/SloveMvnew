...
import com.ming.slove.mvnew.common.widgets.gallerfinal.adapter.FolderListAdapter;
import com.ming.slove.mvnew.common.widgets.gallerfinal.adapter.PhotoListAdapter;
import com.ming.slove.mvnew.common.widgets.gallerfinal.model.PhotoFolderInfo;
import com.ming.slove.mvnew.common.widgets.gallerfinal.model.PhotoInfo;
import com.ming.slove.mvnew.common.widgets.gallerfinal.permission.AfterPermissionGranted;
import com.ming.slove.mvnew.common.widgets.gallerfinal.permission.EasyPermissions;
import com.ming.slove.mvnew.common.widgets.gallerfinal.utils.PhotoTools;
...
public class PhotoSelectActivity extends PhotoBaseActivity implements View.OnClickListener, AdapterView.OnItemClickListener{
    ...
    private void takeRefreshGallery(PhotoInfo photoInfo) {
        ...
        if ( mFolderListAdapter.getSelectFolder() != null ) {
            ...
            for (int i = 1; i < mAllPhotoFolderList.size(); i++) {
                ...
                String folderB = null;
                if (!ToolUtils.isEmpty(photoInfo.getPhotoPath())) {
    ...
    private void folderItemClick(int position) {
        ...
        if (position == 0) {
            ...
            if (photoInfo != null && !ToolUtils.isEmpty(photoInfo.getPhotoPath())) {
    ...
    private void photoItemClick(View view, int position) {
        ...
        if (!GalleryFinal.getFunctionConfig().isMutiSelect()) {
            ...
            String ext = ToolUtils.getExtension(info.getPhotoPath());
