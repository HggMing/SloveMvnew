...
public class NineGridImageView<T> extends ViewGroup {
    ...
    private int mLength_X;  //宫格横向比例
    private int mWidth_Y;  //宫格纵向比例
    ...
    public NineGridImageView(Context context, AttributeSet attrs) {
        ...
        this.mLength_X = typedArray.getInt(R.styleable.NineGridImageView_length_X, 1);
        this.mWidth_Y = typedArray.getInt(R.styleable.NineGridImageView_width_Y, 1);
        typedArray.recycle();
    }
