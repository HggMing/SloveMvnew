...
import static com.ming.slove.mvnew.common.widgets.rxdownload.DownloadHelper.TEST_RANGE_SUPPORT;
import static com.ming.slove.mvnew.common.widgets.rxdownload.FileHelper.TAG;
        ...
        return mDownloadHelper.getDownloadApi()
                ...
                .map(new Func1<Response<Void>, DownloadType>() {
                    ...
                    public DownloadType call(Response<Void> resp) {
                        ...
                        } else if(Utils.serverFileFir(resp)){
                            return getWhenServerFileChanged(resp, url);
                        }
                        else {
